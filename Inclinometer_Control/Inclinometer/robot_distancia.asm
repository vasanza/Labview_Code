...
;robot_distancia.mbas,42 :: 		PORTB.5 = MaskPort.0
	BTFSC      _MaskPort+0, 0
	GOTO       L_robot_distancia_interrupt83
	BCF        PORTB+0, 5
	GOTO       L_robot_distancia_interrupt84
L_robot_distancia_interrupt83:
	BSF        PORTB+0, 5
...
;robot_distancia.mbas,144 :: 		for i=20 to 255
	MOVLW      20
	MOVWF      _i+0
L_robot_distancia_rotar_servo58:
	MOVF       _i+0, 0
	SUBLW      255
	BTFSS      STATUS+0, 0
	GOTO       L_robot_distancia_rotar_servo61
...
;robot_distancia.mbas,148 :: 		if distancia < Index then
	...
	BTFSS      STATUS+0, 2
	GOTO       L_robot_distancia_rotar_servo86
	MOVF       _Index+0, 0
	SUBWF      _distancia+0, 0
L_robot_distancia_rotar_servo86:
	BTFSC      STATUS+0, 0
	GOTO       L_robot_distancia_rotar_servo63
...
;robot_distancia.mbas,150 :: 		delay_ms(10)
	...
	MOVLW      248
	MOVWF      R13+0
L_robot_distancia_rotar_servo65:
	DECFSZ     R13+0, 1
	GOTO       L_robot_distancia_rotar_servo65
	DECFSZ     R12+0, 1
	GOTO       L_robot_distancia_rotar_servo65
	NOP
L_robot_distancia_rotar_servo63:
...
;robot_distancia.mbas,154 :: 		next i
	...
	GOTO       L_robot_distancia_rotar_servo61
	INCF       _i+0, 1
	GOTO       L_robot_distancia_rotar_servo58
L_robot_distancia_rotar_servo61:
...
L_robot_distancia_rotar_servo66:
	...
	SUBLW      255
	BTFSS      STATUS+0, 0
	GOTO       L_robot_distancia_rotar_servo69
...
;robot_distancia.mbas,160 :: 		if distancia < Index then
	...
	SUBWF      _distancia+1, 0
	BTFSS      STATUS+0, 2
	GOTO       L_robot_distancia_rotar_servo87
	MOVF       _Index+0, 0
	SUBWF      _distancia+0, 0
L_robot_distancia_rotar_servo87:
	BTFSC      STATUS+0, 0
...
L_robot_distancia_rotar_servo69:
